        ...
        <div className="space-y-6">
            < div className="flex justify-between items-center">
                < div >
                    ...
                    < p className="text-gray-600">Manage subscription service balance accounts</p>
                </div >
                                        ...
                                        < div className="flex items-center space-x-3">
                                            ...
                                            < div >
                                                <p className="text-sm font-medium text-gray-900">
                                                    {alert.type === 'NEGATIVE' ? 'Negative Balance' : 'Low Balance Warning'}
                                                </p >
                    ...
                    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
                        < div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
                            < div className="flex justify-between items-center mb-4">
                                < h3 className="text-xl font-bold">Inject Balance</h3>
                            ...
                            <form onSubmit={handleInject} className="space-y-4">
                                < div >
                                    ...
                                    < p className="mt-1 text-lg font-semibold text-gray-900">{selectedAccount?.service.name}</p>
                                </div >
                                <div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder="e.g., Morning balance top-up"
                                    />
                                </div >
                                <div className="flex justify-end space-x-3 mt-6">
                                    ...
                                    >
                                        {injectMutation.isPending ? 'Injecting...' : 'Inject Balance'}
                                    </button >
                                </div >
                            </form >
                        </div >
