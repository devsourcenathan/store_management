        ...
        <Sheet open={true} onOpenChange={(open) => !open && onClose()}>
            <SheetContent side="right" className="sm:max-w-lg overflow-y-auto bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* New End Date */}
                    <div className="bg-theme-primary/10 p-4 rounded-xl border border-theme-primary/20 flex items-center justify-between">
                    ...
                    <div className="flex justify-end space-x-3 pt-6 border-t border-gray-100 dark:border-gray-700 mt-2">
                        ...
                        <button
                            ...
                            className="flex-2 px-6 py-2.5 btn-theme-primary rounded-lg disabled:opacity-50 disabled:cursor-not-allowed font-bold shadow-sm transition-all flex items-center justify-center"
                        >
