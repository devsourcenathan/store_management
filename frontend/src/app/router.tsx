...
import { CashAdjustmentsList } from '@/features/cash-adjustments/pages/CashAdjustmentsList';
import { MiscTransactionsList } from '@/features/misc-transactions/pages/MiscTransactionsList';
